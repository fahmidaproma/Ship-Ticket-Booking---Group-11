...
<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		else if(strlen($_POST["num"])<5)
		{
		  $err_num="*Phone Number Must Contain At Least 5 Character";
		  $hasError = true;
		}
		else{
		...
		if(!$hasError){
			$query = "insert into update_customer values('$id','$uname','$pass','$email','$num','$add','$birth')";
			execute($query);							  
		}
	}
...
<html>
    ...
    <body>	      	 
		<div class="signupdiv">		 		  		
			...
			<legend align="center">
				<tr>				  				    
		            <td><h1 align="center" style="font-family:verdana;">Update Customer</h1></td>					
				</tr>
			</legend>
