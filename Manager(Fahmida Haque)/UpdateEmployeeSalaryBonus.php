...
<html>
    ...
    <body>	
		...
		<div class="signupdiv">		 		  		
			...
			<legend align="center">
				<tr>				  				    
		            <td><h1 align="center" style="font-family:verdana;">Update Employee Salary Bonus</h1></td>					
				</tr>
			</legend>
			...
			<form action="" method="post" class="form-horizontal form-material" onsubmit="return validate()">
				...
				<tr>
					...
					<td>:
						<input type="text" placeholder="Bonus" id="bonus" name="bonus" value="<?php echo $bonus?>">
						<span id="err_bonus"><?php echo $err_bonus?></span></td>
				</tr>
				<tr>
					<td><span>Employers Total Salary</span></td>
					<td>:
						<input type="number" placeholder="Total Salary" id="total_salary" name="total_salary" value="<?php echo $total_salary?>">
						<span id="err_total_salary"><?php echo $err_total_salary?></span></td>
				</tr>
					   <td colspan="2" align="center">
					    ...
					    <tr>						
						   <td colspan="2" align="center"><input class="btn-mine my-font" type="submit"  value="Update Salary" name="signup">	</td>						   
					    </tr>
	 ...
	 <script>
	   ...
	   function validate(){
		   ...
		   if(get("total_salary").value == ""){
			   get ("err_total_salary").innerHTML="*Total Salary Required<br>";
			   get ("err_total_salary").style.color="red";
			   hasError=true;			   
		   }
		   //alert (err_msg);
		   if(!hasError){
		...
		function cleanUp(){
			...
			get ("err_total_salary").innerHTML="";
		}
