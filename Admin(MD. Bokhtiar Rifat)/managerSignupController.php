...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(!$hasError){
        ...
        insertManager($name , $email , $passwords ,  $username , $contact , $gender );
  ...
  function insertManager($name,$email,$passwords,$username,$contact,$gender){
    $query = "INSERT INTO all_manager values(NULL,'$name','$email','$passwords','$username','$contact','$gender')";  
    execute($query);
...
function checkUsernameValidity($username){
  $query = "select * from all_manager where username='$username'";
  $result = get($query);
